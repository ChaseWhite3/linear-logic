...
%\RightLabel{$\with$}
\UnaryInfC{$\langle A \multimap B\rangle ,\langle A\rangle \nvdash A \otimes  B$}
\end{prooftree}
\end{minipage}
%\begin{minipage}[l] {.50\linewidth}
%\begin{prooftree}
...
%Explain certain set of inference rules I used.

%Problems with certain rules causing undecidability.

%spliting thm, why its necessary
